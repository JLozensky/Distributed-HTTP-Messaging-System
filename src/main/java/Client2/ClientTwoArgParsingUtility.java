...
public class ClientTwoArgParsingUtility {
    ...
    public static ClientTwo makeClient(String[] args){
        // Create default values list
        HashMap<String, String> clientValues = ClientTwoArgParsingUtility.getStartingValues();
        ...
        if (invalidValues) {System.out.println(ClientTwoArgParsingUtility.errorMessageGenerator());}
        ...
        for (String flag : clientValues.keySet()){
            boolean validValue = ClientTwoArgParsingUtility.validateEntry(flag, clientValues.get(flag));
            String temp;
            while (validValue == false) {
                System.out.println(ClientTwoArgParsingUtility.errorMessageGenerator(flag, clientValues.get(flag)));
                clientValues.put(flag,console.readLine());
                validValue = ClientTwoArgParsingUtility.validateEntry(flag,clientValues.get(flag));
            }
        }
