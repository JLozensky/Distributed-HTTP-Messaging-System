...
public final class ContentValidationUtilityA2 {

    private ContentValidationUtilityA2(){}
    ...
    public static boolean validateLiftRideAndSkierDay(String[] urlParts) {
        ...
        int skierIdIndex = 7;
        if (
            ContentValidationUtilityA2.isResort(urlParts[resortIdIndex]) &&
                urlParts[seasonsText].equals("seasons") &&
                ContentValidationUtilityA2.isSeason(urlParts[seasonIdIndex]) &&
                urlParts[daysText].equals("days") &&
                ContentValidationUtilityA2.isDayId(urlParts[dayIdIndex]) &&
                urlParts[skiersText].equals("skiers") &&
                ContentValidationUtilityA2.isSkier(urlParts[skierIdIndex])
        ) {
